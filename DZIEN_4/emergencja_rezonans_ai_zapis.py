...
# Konfiguracja do zapisu wideo
matplotlib.use("Agg")
Writer = animation.writers['ffmpeg']
writer = Writer(fps=10, metadata=dict(artist='AI Resonance Demo'), bitrate=1800)
...
for _ in range(NUM_AGENTS):
    ...
    agents.append({'x': float(x), 'y': float(y), 'phase': phase})
...
# Zapis do MP4
ani.save("emergencja_rezonans_ai.mp4", writer=writer)
print("Zapisano wideo jako emergencja_rezonans_ai.mp4")
